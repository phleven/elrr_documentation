...
// Lanes
const lanes = ['Regular', 'Ready', 'SENTRI'];
...
async function insertData() {
	...
	try {
		...
		for (let i = 0; i < 10000; i++) {
			...
			const vechicleEncounterData = [
				{
				    ...
				    "encAttr": [
						...
						{"key": "lane", "value": faker.helpers.arrayElement(lanes)},
			...
			const result = await collection.insertMany(vechicleEncounterData);
		}
